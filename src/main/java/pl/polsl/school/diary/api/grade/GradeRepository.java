...
public interface GradeRepository extends JpaRepository<Grade, Long> {
    ...
    List<GradeProjection> findStudentGradesOfParent(Long studentId, Long subjectId, Long parentId);
    ...
    List<GradeProjection> findStudentGradesByTeacher(Long studentId, Long subjectId, Long teacherId);
    ...
    List<GradeProjection> findStudentGrades(Long studentId, Long subjectId);
